...
class P4HDogAdoption(CrawlerInfoBase):
    
    def __init__(self):
        self.name = "p4hdogadoption"
    ...
    def run(self, params):
        ...
        FILTER_URL_SEARCH = "https://www.pets4homes.co.uk/dog-breeds/"
        PREFIX_URL_ADOPTION = "https://www.pets4homes.co.uk/adoption/dogs"
        ...
        self.browser["q"] = input_search +" site:pets4homes.co.uk/dog-breeds"
        ...
        # 1passo
        # costruisci il link per l'adozione dei cani
        # del tipo """https://www.pets4homes.co.uk/adoption/dogs/<<CODICE CANE>>/"""
